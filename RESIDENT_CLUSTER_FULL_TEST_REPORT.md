...
| 场景 | 模式与参数 | CST（UTC+8）时间边界 | 耗时 | 指标时间窗（毫秒） | 结果目录 |
| ---: | --- | --- | ---: | --- | --- |
| 1 | 非 Gang，`10000 job × 1 pod` | `2026-08-11 12:05:35` 至 `2026-08-11 12:12:52` | `7m17s` | `1786421135459` 至 `1786421556770` | `results/1786421572` |
| 2 | 非 Gang，`500 job × 20 pod` | `2026-08-11 12:12:52` 至 `2026-08-11 12:16:28` | `3m36s` | `1786421572718` 至 `1786421773983` | `results/1786421788` |
| 3 | 非 Gang，`20 job × 500 pod` | `2026-08-11 12:16:28` 至 `2026-08-11 12:20:12` | `3m44s` | `1786421788823` 至 `1786421997721` | `results/1786422012` |
| 4 | 非 Gang，`1 job × 10000 pod` | `2026-08-11 12:20:12` 至 `2026-08-11 12:24:11` | `3m59s` | `1786422018261` 至 `1786422235920` | `results/1786422251` |
| 5 | Gang，`10000 job × 1 pod` | `2026-08-11 12:24:11` 至 `2026-08-11 12:32:41` | `8m30s` | `1786422258533` 至 `1786422746680` | `results/1786422761` |
| 6 | Gang，`500 job × 20 pod` | `2026-08-11 12:32:41` 至 `2026-08-11 12:38:09` | `5m28s` | `1786422768318` 至 `1786423074628` | `results/1786423089` |
| 7 | Gang，`20 job × 500 pod` | `2026-08-11 12:38:09` 至 `2026-08-11 12:43:16` | `5m07s` | `1786423096288` 至 `1786423381702` | `results/1786423396` |
| 8 | Gang，`1 job × 10000 pod` | `2026-08-11 12:43:16` 至 `2026-08-11 12:50:15` | `6m59s` | `1786423403376` 至 `1786423800482` | `results/1786423815` |
...
- 8 个结果目录全部包含 `envs.txt` 和 `result-window.txt`，目录命名与现有时间戳归档方式保持不变。
